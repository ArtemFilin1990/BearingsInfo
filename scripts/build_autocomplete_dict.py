...
class AutocompleteDictBuilder:
    ...
    def extract_terms_from_documents(self) -> Dict[str, int]:
        ...
        technical_terms = [
            'подшипник', 'подшипники', 'подшипниковый', 'подшипниковые',
            'сепаратор', 'зазор', 'посадка', 'преднатяг',
            'шариковый', 'роликовый', 'игольчатый', 'конический',
            'радиальный', 'упорный', 'упорно-радиальный',
            'уплотнение', 'уплотнения', 'уплотнительный',
            'втулка', 'втулки', 'вал', 'корпус',
            'нагрузка', 'скорость', 'температура', 'смазка',
            'монтаж', 'демонтаж', 'ресурс', 'износ',
            'качение', 'скольжение', 'трение',
            'серия', 'стандарт', 'гост', 'iso',
            'диаметр', 'ширина', 'высота', 'размер',
            'аналог', 'взаимозаменяемость', 'замена',
            'каталог', 'маркировка', 'обозначение'
        ]
