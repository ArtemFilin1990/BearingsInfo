...
def generate_processed_filename(
    original_name: str, n_records: int, file_hash: str, is_error: bool = False, error_code: str | None = None
) -> str:
    ...
    parts = [timestamp, source, f"{n_records}", short_hash]
...
def normalize_number(value: Any, decimal_sep: str = ".") -> float | None:
