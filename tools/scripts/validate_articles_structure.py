...
EXPECTED: list[tuple[str, str]] = [
    ...
    ("docs/articles/bearings/1_1_designations_gost_iso_etu/1_1_8_bearing_types.md", "1.1.8 Типы подшипников"),
    ("docs/articles/bearings/1_1_designations_gost_iso_etu/1_1_9_cages.md", "1.1.9 Сепараторы подшипников качения"),
    ("docs/articles/bearings/1_1_designations_gost_iso_etu/1_1_10_lubrication.md", "1.1.10 Смазка подшипников"),
    (
    ...
    ("docs/articles/bearings/1_2_standards_and_codes/1_2_1_gost_standards.md", "1.2.1 ГОСТ. Подшипники. Стандарты"),
    ("docs/articles/bearings/1_2_standards_and_codes/1_2_2_iso_standards.md", "1.2.2 ISO. Стандарты подшипников"),
    (
    ...
    ("docs/articles/bearings/1_2_standards_and_codes/1_2_7_tnved_codes.md", "1.2.7 Коды ТН ВЭД на подшипники"),
    (
    ...
    ("docs/articles/bearings/1_3_general_information/1_3_2_bearing_components.md", "1.3.2 Из чего состоит подшипник"),
    ("docs/articles/bearings/1_3_general_information/1_3_3_how_bearings_are_made.md", "1.3.3 Как делают подшипники"),
    ("docs/articles/bearings/1_3_general_information/1_3_4_how_to_choose_bearing.md", "1.3.4 Как выбрать подшипник"),
    ("docs/articles/bearings/1_3_general_information/1_3_5_classification.md", "1.3.5 Классификация подшипников"),
    (
    ...
    ("docs/articles/bearings/1_3_general_information/1_3_8_loads.md", "1.3.8 Нагрузки на подшипники"),
    (
        "docs/articles/bearings/1_3_general_information/1_3_9_contact_angle.md",
        "1.3.9 Угол контакта (радиально-упорные)",
    ),
    ("docs/articles/bearings/1_3_general_information/1_3_10_design_variants.md", "1.3.10 Конструктивные разновидности"),
    ("docs/articles/bearings/1_3_general_information/1_3_11_preload.md", "1.3.11 Предварительный натяг"),
    ("docs/articles/bearings/1_3_general_information/1_3_12_limiting_speed.md", "1.3.12 Предельная частота вращения"),
    ("docs/articles/bearings/1_3_general_information/1_3_13_duplex_sets.md", "1.3.13 Комплекты подшипников (дуплекс)"),
    ("docs/articles/bearings/1_3_general_information/1_3_14_marking.md", "1.3.14 Маркировка подшипников"),
    (
    ...
    ("docs/articles/bearings/1_3_general_information/1_3_16_miniature.md", "1.3.16 Миниатюрные подшипники"),
    (
        "docs/articles/bearings/1_3_general_information/1_3_17_high_temperature.md",
        "1.3.17 Высокотемпературные подшипники",
    ),
    ("docs/articles/bearings/1_3_general_information/1_3_18_installation.md", "1.3.18 Монтаж подшипников"),
    ("docs/articles/bearings/1_3_general_information/1_3_19_depreservation.md", "1.3.19 Переконсервация"),
    ("docs/articles/bearings/1_3_general_information/1_3_20_fits.md", "1.3.20 Посадки подшипников"),
    ("docs/articles/bearings/1_3_general_information/1_3_21_inspection.md", "1.3.21 Ревизия подшипников"),
    ("docs/articles/bearings/1_3_general_information/1_3_22_storage_and_packaging.md", "1.3.22 Хранение и упаковка"),
    (
        "docs/articles/bearings/1_3_general_information/1_3_23_damage_causes.md",
        "1.3.23 Причины повреждения подшипников",
    ),
    ("docs/articles/bearings/1_3_general_information/1_3_24_defect_terminology.md", "1.3.24 Терминология дефектов"),
    (
    ...
    ("docs/articles/bearings/1_4_types_and_modifications/1_4_11_hybrid_bearings.md", "1.4.11 Гибридные подшипники"),
    ("docs/articles/bearings/1_4_types_and_modifications/1_4_12_conveyor_rollers.md", "1.4.12 Конвейерные ролики"),
    ("docs/articles/bearings/1_4_types_and_modifications/1_4_13_bicycle_bearings.md", "1.4.13 Велосипедные подшипники"),
    ("docs/articles/bearings/1_4_types_and_modifications/1_4_14_spindle_bearings.md", "1.4.14 Шпиндельные подшипники"),
    (
    ...
    ("docs/articles/bearings/1_5_brands_and_manufacturers/1_5_6_skf_explorer.md", "1.5.6 Подшипники SKF Explorer"),
    (
    ...
    ("docs/articles/bearings/1_6_rolling_elements_nuts_sleeves/1_6_5_nuts.md", "1.6.5 Гайки"),
    ("docs/articles/bearings/1_7_plain_bushings/1_7_1_plain_bushings.md", "1.7.1 Втулки скольжения"),
    ("docs/articles/bearings/1_7_plain_bushings/1_7_2_plain_bearings.md", "1.7.2 Подшипники скольжения"),
    (
    ...
    ("docs/articles/bearings/1_8_automotive/1_8_3_hub_failure_symptoms.md", "1.8.3 Симптомы неисправностей ступицы"),
    (
    ...
    ("docs/articles/bearings/1_9_misc/1_9_1_chinese_bearings.md", "1.9.1 Китайские подшипники"),
    ("docs/articles/bearings/1_9_misc/1_9_2_interesting.md", "1.9.2 Интересное о подшипниках"),
    ("docs/articles/bearings/1_9_misc/1_9_3_wooden_bearings.md", "1.9.3 Деревянные подшипники"),
    ("docs/articles/bearings/1_9_misc/1_9_4_english_terms.md", "1.9.4 Термины на английском языке"),
    ("docs/articles/bearings/1_9_misc/1_9_5_word_bearing_in_languages.md", "1.9.5 Слово «подшипник» на разных языках"),
    ("docs/articles/bearings/1_9_misc/1_9_6_humor.md", "1.9.6 С юмором о подшипниках"),
    ("docs/articles/2_ball_joints/2_1_ball_joint.md", "2.1 Шариковая опора"),
    (
        "docs/articles/3_linear_guides_and_ball_screws/3_1_linear_guides.md",
        "3.1 Линейные направляющие качения и скольжения",
    ),
    ("docs/articles/3_linear_guides_and_ball_screws/3_2_ball_screw.md", "3.2 ШВП — шариковая винтовая передача"),
    (
    ...
    ("docs/articles/4_rti_gost/4_1_rti_overview.md", "4.1 ГОСТ Резино-технические изделия (РТИ)"),
    ("docs/articles/5_drive_belts/5_1_drive_belts.md", "5.1 Приводные ремни"),
    ("docs/articles/5_drive_belts/5_2_belt_selection_by_size.md", "5.2 Подбор ремня по размеру"),
    ("docs/articles/5_drive_belts/5_3_belt_drive_failures.md", "5.3 Неисправности ременной передачи"),
    ("docs/articles/5_drive_belts/5_4_gost_vs_import_belt_sizes.md", "5.4 Размеры и аналоги (ГОСТ ↔ импорт)"),
    ("docs/articles/5_drive_belts/5_5_belt_length_calculation.md", "5.5 Расчёт длины ремня"),
    ("docs/articles/6_seals_and_cuffs/6_1_reinforced_rubber_seals.md", "6.1 Резиновые армированные манжеты (сальники)"),
    ("docs/articles/6_seals_and_cuffs/6_2_seal_selection_by_size.md", "6.2 Подбор сальника или манжеты по размерам"),
    ("docs/articles/7_hoses_and_rvd/7_1_industrial_hoses.md", "7.1 Промышленные рукава и шланги"),
    ("docs/articles/7_hoses_and_rvd/7_2_high_pressure_hoses_rvd.md", "7.2 Рукава высокого давления (РВД)"),
    ("docs/articles/8_o_rings/8_1_o_rings.md", "8.1 Кольца резиновые уплотнительные круглого сечения"),
    ("docs/articles/9_pulleys/9_1_pulleys_for_belts.md", "9.1 Шкивы для приводных ремней"),
    ("docs/articles/9_pulleys/9_2_skf_pulleys_for_narrow_v_belts.md", "9.2 Шкивы SKF для узких клиновых ремней"),
    ("docs/articles/10_chains_and_sprockets/10_1_drive_chains.md", "10.1 Приводные цепи"),
    ("docs/articles/10_chains_and_sprockets/10_2_chain_drive.md", "10.2 Цепная передача"),
    ("docs/articles/10_chains_and_sprockets/10_3_sprockets.md", "10.3 Звёздочки"),
    ("docs/articles/10_chains_and_sprockets/10_4_gost_chains_sprockets.md", "10.4 ГОСТ цепи и звёздочки"),
    ("docs/articles/11_accessories/11_1_circlips.md", "11.1 Стопорные кольца"),
    ("docs/articles/11_accessories/11_2_filters.md", "11.2 Фильтры"),
    ("docs/articles/11_accessories/11_3_technical_fluids.md", "11.3 Технические жидкости"),
    (
        "docs/articles/11_accessories/11_4_quick_couplings_camlock_fittings.md",
        "11.4 Быстроразъёмные соединения (БРС, CAMLOCK, фитинги)",
    ),
    ("docs/articles/11_accessories/11_5_gear_pumps_nsh.md", "11.5 Насосы шестерённые НШ"),
    ("docs/articles/11_accessories/11_6_gearboxes.md", "11.6 Редукторы"),
    ("docs/articles/11_accessories/11_7_taper_bush.md", "11.7 Втулки TAPER BUSH"),
]
